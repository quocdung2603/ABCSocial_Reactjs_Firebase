        ...
        <div class="flex h-screen">
            <div class="hidden lg:flex items-center justify-center flex-1 bg-white text-black">
                <div class="max-w-md text-center">
                    <svg width="524.67004" height="531.39694" class="w-full" alt="/" title="https://undraw.co/illustrations" viewBox="0 0 524.67004 531.39694">
                ...
                <div class="max-w-md w-full p-6">
                    ...
                    <form onSubmit={handleSubmit} class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="file" id="image" name="image" class="mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300" />
                        </div>
                        <div>
